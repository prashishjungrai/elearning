  ...
  return (
    ...
    >
      <Link href={to} className="hover:!bg-[unset]">
        <Typography className="!text-[16px] !font-Poppins text-black ">
          {title}
        </Typography>
      </Link>
    </MenuItem>
        ...
        <Menu>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item
              title="Users"
              to="/admin/users"
              icon={<GroupsIcon className="text-black " />}
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              ...
              to="/admin/invoices"
              icon={
                <ReceiptOutlinedIcon className="text-black " />
              }
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              ...
              icon={<VideoCallIcon className="text-black" />}
              selected={selected}
              setSelected={setSelected}
            />
            <Item
              ...
              to="/admin/courses"
              icon={
                <OndemandVideoIcon className="text-black " />
              }
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              title="FAQ"
              to="/admin/faq"
              icon={<QuizIcon className="text-black " />}
              selected={selected}
              setSelected={setSelected}
            />
            <Item
              title="Categories"
              to="/admin/categories"
              icon={<WysiwygIcon className="text-black " />}
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <div onClick={logoutHandler}>
              <Item
                title="Logout"
                to="/"
                icon={<ExitToAppIcon className="text-black " />}
                selected={selected}
                setSelected={setSelected}
              />
            </div>
